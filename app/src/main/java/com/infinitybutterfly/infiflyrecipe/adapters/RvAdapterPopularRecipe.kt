...
class RvAdapterPopularRecipe(
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val foodImage: ImageView = itemView.findViewById(R.id.popular_recipe_dish_img)
        val titleText: TextView = itemView.findViewById(R.id.popular_recipe_dish_name)
        val countryString: TextView = itemView.findViewById(R.id.popular_recipe_country_name)
    }
}
